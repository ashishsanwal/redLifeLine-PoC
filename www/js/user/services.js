        ...
        function ($q, ParseConfiguration) {
            ...
            return {
                ...
                createUser: function (_userParams) {
                    ...
                    user.set("blood_group", _userParams.bloodgroup);
                    user.set("phone", _userParams.phone);
                    user.set("street", _userParams.street);
                    user.set("location", _userParams.location);
                    user.set("city", _userParams.city);
                    user.set("state", _userParams.state);
                    user.set("pincode", _userParams.pincode);
